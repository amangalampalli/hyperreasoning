...
Source task: `data/generated_tasks/medium/stateful_iterator_resume_bug_4007`

Status: intentionally broken starting state for the live comparison demo.

Same-pipeline demo-folder scan:

- Rainbow: solved, 4/4 tests, 1310 tokens, 24.0s
- Heuristic: solved, 4/4 tests, 1546 tokens, 27.1s
- One-shot: solved, 4/4 tests, 4453 tokens, 84.8s
- Random: partial, 3/4 tests, 3305 tokens, 70.2s
